...
def get_weather():
     try:   
        #Location:
        city= textfield.get()
        geolocator = Nominatim(user_agent="geopiExrcises")
        ...
        # weather
        api_key = "093713581857dce9a6308cff5b0c2df2"
...
search_icon_button.place(x=500, y=34)
...
#Labels:
labell = tk.Label(root, text="WIND", font=("Helvetica",15, "bold"),
                  fg="white", bg="#1ab5ef")
